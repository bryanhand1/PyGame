...
class AlienInvasion:
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                sys.exit()
            # Starting the game from play button
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # If so get rid of the bullet and the aliend
        ...
        if not self.aliens:
            # Destory existing bullets and crate new fleet.
            self.bullets.empty()
            self._create_fleet()
    ...
    def _create_fleet(self):
        ...
        # Creat an alien and find the number ofaliens in a row
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat this is same as if the ship got hit
                self._ship_hit()
                break
